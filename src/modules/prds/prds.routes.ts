...
const router = Router();
const prdsController = new PRDsController();
 ...
 */
router.post('/', validateBody(createPRDSchema), prdsController.createPRD);
 ...
 * @access  Private (Project members)
 */
router.get('/', prdsController.getPRDs);
 ...
 * @access  Private (Project members)
 */
router.get('/:id', prdsController.getPRDById);
 ...
 */
router.put('/:id', validateBody(updatePRDSchema), prdsController.updatePRD);
...
router.patch(
  ...
  prdsController.updatePRDStatus
);
 ...
 */
router.delete('/:id', prdsController.deletePRD);
 ...
 * @access  Private (Project members)
 */
router.get('/:id/versions', prdsController.getPRDVersions);
